...
//girls table
$sql="SELECT DISTINCT UPPER( column_name) FROM INFORMATION_SCHEMA.COLUMNS where TABLE_SCHEMA='zakeirag_recruitment' &&  TABLE_NAME='girls'  and column_name not like'%_id'&& column_name not like '%update%'";
...
//uploads table
//$sql="SELECT DISTINCT UPPER( column_name) FROM INFORMATION_SCHEMA.COLUMNS where TABLE_SCHEMA='zakeirag_recruitment' &&  TABLE_NAME='uploads'  and column_name not like'%_id' ";
//
//$result=$connect->query($sql) ;
//  
//  
...
//next of kin table
$sql="SELECT DISTINCT UPPER( column_name) FROM INFORMATION_SCHEMA.COLUMNS where TABLE_SCHEMA='zakeirag_recruitment' &&  TABLE_NAME='next_of_kin'  and column_name not like'%_id' ";
