      ...
      <div class="card p-4">
        ...
        <div class="collapse show" id="collapseExample">
          <div class="card-body str-view">
            ...
            <button type="button " class="btn btn-primary suggestion-button fade d-none" data-toggle="modal" data-target="#clearanceModal">
              Show changes
            </button>
            ...
            <ul class="list-group custom-list-group rounded-3 d-none">
              <li class="list-group-item d-flex flex-row justify-content-between custom-list-group-item tasks">
                <span class="maid-name">Start Typing...</span>
            ...
            <!-- Button trigger modal -->
            <button type="button " class="btn btn-primary selection-button fade" data-toggle="modal" data-target="#clearanceModal">
              Show changes
            </button>
