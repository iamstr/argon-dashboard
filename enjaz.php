      ...
      <div class="card p-4">
        ...
        <div class="collapse show" id="collapseExample">
          <div class="card-body str-view">
            ...
            <div class="btn-group btn-group-toggle ml-1 mb-5 mt-2 d-none" data-toggle="buttons">
            ...
            <ul class="list-group custom-list-group rounded-3 d-none">
              <li class="list-group-item d-flex flex-row justify-content-between custom-list-group-item tasks">
                <span class="text-muted">Start Typing...</span>
            ...
            <!-- Button trigger modal -->
            <button type="button " class="btn btn-primary selection-button fade" data-toggle="modal" data-target="#enjazModal">
              Show changes
            </button>
