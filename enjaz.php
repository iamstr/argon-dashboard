  ...
  <div class="main-content" id="panel">
   ...
   <?php include("includes/top-nav.php");?>
    <div class="container-fluid mt-5">
      <div class="card p-4">
        <p>
          <button class="btn btn-icon btn-secondary btn-sm" type="button" data-toggle="collapse"
            data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" style="display: none">
        ...
        <div class="collapse show" id="collapseExample">
          <div class="card-body str-view">
            ...
            <div class="form-group position-relative">
              <input type="search" class="form-control form-control-muted search-input"
                placeholder="Search by Name or ID or Passport Number" />
              <img src="assets/img/icons/search.svg" alt="search icon" class="search-input position-absolute"
            ...
            <button type="button " class="btn btn-primary selection-button fade" data-toggle="modal"
            ...
            <!-- Button trigger modal -->
            <button type="button " class="btn btn-primary suggestion-button fade" data-toggle="modal"
              data-target="#exampleModal">
              Show changes
            </button>
          </div>
                ...
                <thead class="thead-light">
                  <tr class="table-agent position-relative">
                    ...
                    <th scope="col" class="sort" data-sort="passport">
                      <div class="dropdown">
                        <a class="" href="#passport" role="button" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="true">
                          Paasport Number
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" x-placement="bottom-end"
                    ...
                    <th scope="col" class="sort" data-sort="medical">
                      <div class="dropdown">
                        <a class="" href="#medical" role="button" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="true">
                          Full Medical
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" x-placement="bottom-end"
                    ...
                    <th scope="col" class="sort" data-sort="wakala">
                      <div class="dropdown">
                        <a class="" href="#wakala" role="button" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="true">
                          Wakala
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" x-placement="bottom-end"
                    ...
                    <th scope="col" class="sort" data-sort="enjaz">
                      <div class="dropdown">
                        <a class="" href="#enjaz" role="button" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="true">
                          Enjaz
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" x-placement="bottom-end"
                    ...
                    <th scope="col" class="sort" data-sort="status">
                      <div class="dropdown">
                        <a class="" href="#status" role="button" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="true">
                          Status
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" x-placement="bottom-end"
