      ...
      <div class="card p-4">
        ...
        <div class="collapse show" id="collapseExample">
          <div class="card-body str-view">
            ...
            <button type="button " class="btn btn-primary suggestion-button fade d-none" data-toggle="modal" data-target="#travelModal">
              Show changes
            </button>
            ...
            <!-- Button trigger modal -->
            <button type="button " class="btn btn-primary selection-button fade" data-toggle="modal" data-target="#travelModal">
              Show changes
            </button>
